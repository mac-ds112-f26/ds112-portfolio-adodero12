...
What is the geography of these votes?
...
# change: added repub_pct_16 as the x value, moved repub_pct_20 to the y
...
# it changes the shape of the points
ggplot(elections, aes(y = repub_pct_20, x = repub_pct_16)) +
  geom_point(shape = 3)
```
...
ggplot(elections, aes(y = repub_pct_20, x = median_rent)) +
  geom_point()
# Slightly negative, more clear relationship!

# Scatterplot of repub_pct_20 vs median_age
ggplot(elections, aes(y = repub_pct_20, x = median_age)) +
  geom_point()
# Relationship not as clear
...
# The points are too clustered, not very insightful to show relationship
```
...
# Slightly more helpful, shows deviations, but still not very insightful
```
...
# Slightly more helpful, shows median, maximum, minimum and outliers. Shows how 2020 election compares to overall elections in history.
```
